...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<tblReplaceVerify> _dataList;

    public RecyclerViewAdapter(List<tblReplaceVerify> dataList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HeaderViewHolder) {
            ...
            tblReplaceVerify data = _dataList.get(position - 1);//Subtract 1 because the header is at position 0
            ItemViewHolder itemViewHolder = (ItemViewHolder) holder;
            itemViewHolder.txtWO.setText(data.getWO());
            itemViewHolder.txtLine.setText(data.getLINE());
            itemViewHolder.txtMachine.setText(data.getMACHINE());
            itemViewHolder.txtSlot.setText(data.getSLOT());
        }
